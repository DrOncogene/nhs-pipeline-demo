...
## Data Source
The RTT data is sourced from the NHS England statistics website, which publishes monthly reports and datasets. See [NHSE RTT Data](https://www.england.nhs.uk/statistics/statistical-work-areas/rtt-waiting-times/). The data in the `data/` directory is a sample of the data downloaded from the NHSE website and the cleaned data that is loaded into the Databricks workspace.
